export const Layout = ({ children }: LayoutProps) => (
	<>
		<div className="mx-auto flex w-screen max-w-7xl justify-center bg-amber-500 px-4 sm:px-6 lg:bg-white lg:px-8">
		...
		<div className="mx-auto flex w-screen max-w-7xl justify-center bg-white px-4 sm:px-6 lg:px-8">
